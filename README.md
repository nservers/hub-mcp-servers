...
| [`redis-mcp/`](./redis-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-redis:latest` | Redis key-value inspection, memory telemetry, TTL analysis, and read-only cache exploration. |
| [`sqlite-mcp/`](./sqlite-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-sqlite:latest` | SQLite & LibSQL embedded database query runner and schema inspector for local and cloud environments. |
| [`cloud-connect-mcp/`](./cloud-connect-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-cloud-connect:latest` | nServers Cloud VPS control plane connector for real-time node metrics, resource telemetry, and container states. |
| [`docker-mcp/`](./docker-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-docker:latest` | Docker Engine client for inspecting containers, images, volumes, and monitoring live container health metrics. |
| [`git-mcp/`](./git-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-git:latest` | Git repository explorer with support for unified diff generation, commit inspection, and branch tree navigation. |
| [`ecommerce-mcp/`](./ecommerce-mcp) | **Active** | SSE (Port 3000) | `ghcr.io/nservers/hub-mcp-ecommerce:latest` | Read-only e-commerce gateway for WooCommerce and Shopify orders, customer lookup, and real-time inventory counts. |
